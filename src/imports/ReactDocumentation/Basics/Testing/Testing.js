Testing({
  render(){
    <div class="ui segment">
      ...
      <ul>
        <li>Make brittle snapshots that need to be approved whenever you make small changes to the markup.</li>
        <li>Test all permutations of your UI. (Fill A then click button, fill A and B then click button, etc.)</li>
...
describe('Person', () => {
  ...
  describe('bindings', ()=>{
    ...
    it('binds reset button', ()=>{
      ...
      <p>I use Jest because it's simple but of course you can use any other testing framework. I use the following Jest configuration (in package.json):</p>
<pre><code>  "jest": {
    "testPathDirs": [
      "src/"
    ]
...
<pre><code>./Person/Person.js
./Person/Person.test.js</code></pre>
    </div>
  }
});