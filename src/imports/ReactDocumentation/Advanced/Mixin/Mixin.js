Mixin({
  ...
  render(){
    <div class="ui segment">
      ...
      <a class="anchor active" id="AdvancedMixin"></a>
      <p>
...
<pre><code>Wife({
  ...
  render() { <div /> }
      ...
      <p>
        You can supply multiple <a href="#AdvancedAutorun">autorun</a>, <a href="#AdvancedCreated">created</a>, <a href="#AdvancedRendered">rendered</a>, and <a href="#AdvancedDestroyed">destroyed</a> functions with <a href="#AdvancedShare">share</a>, <a href="#AdvancedMixin">mixin</a>, <a href="#AdvancedLoad">load</a>, or in the <a href="#AdvancedDefining">definition</a>.
      </p>
      <p>
