    ...
    <div b="style: panelStyle, hover: hoveringIcon">
      <div style="text-align: left">
        <img src="paper-plane.png"
             style="max-height: 15px; margin: 2px; cursor: pointer;"
             b="toggle: show"
        />
        <span style="margin-left: 10px; font-weight: bold;">View Models</span>
      </div>


      <DisplayComponent viewmodel={ ViewModel.findOne("ReactDocumentation") } />
